 ...
 * Date: 11-4-19
 * ADS Exercise 28-3: Implement DFS using a stack without recursion.
 */
...
public class Exercise28_3 {
	...
	public static void main(String[] args) {
		// Write a new method that performs a depth-first search without using recursion, called dfsNonRecurs().
		
		String[] vertices = {"Seattle", "San Francisco", "Los Angeles",
				"Denver", "Kansas City", "Chicago", "Boston", "New York",
				"Atlanta", "Miami", "Dallas", "Houston"};

		int[][] edges = { // Array of Edges for graph.
				{0, 1}, {0, 3}, {0, 5},
				{1, 0}, {1, 2}, {1, 3},
				{2, 1}, {2, 3}, {2, 4}, {2, 10},
				{3, 0}, {3, 1}, {3, 2}, {3, 4}, {3, 5},
